...
class Borrowing(models.Model):
    ...
    book = models.ForeignKey(Book, on_delete=models.RESTRICT, related_name="borrowings")
    user = models.ForeignKey(get_user_model(), on_delete=models.RESTRICT, related_name="borrowings")
